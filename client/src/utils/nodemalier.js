...
export const sendEmail = async (to, subject, text, html = null) => {
    try {
        ...
        const mailOptions = {
            from: `"Karnue" <${process.env.EMAIL_FROM}>`,
            to,
            subject,
            text
        };
...
export const generateContactEmailHTML = (data) => {
    const { fullName, userType, waitPosition } = data;
    ...
    <head>
        ...
        <title>Thank you for Registering with Karnue</title>
        <style>
    ...
    <body>
        <div class="header">
            <h1>Thank You for Registering with Karnue</h1>
        </div>
        <div class="content">
            <p>Dear ${fullName},</p>
            <p>Thank you for registering with Karnue as a ${userType}. We have received your message and will get back to you as soon as possible.</p>
            
            <p><strong>Your message details:</strong></p>
            <div class="message-box">
                <p><strong>User Type:</strong> ${userType}</p>
                <p><strong>Position:</strong><br>You are number ${waitPosition}</p>
            </div>
            
            <p>If you have any urgent matters, please call us directly at our office.</p>
            <p>Best regards,<br>Karnue Team</p>
        </div>
        <div class="footer">
            <p>© ${new Date().getFullYear()} Karnue. All rights reserved.</p>
...
/**
 * Generate HTML email template for feedback form confirmations
 * @param {object} data - The feedback form data
 * @returns {string} - HTML email content
 */
export const generateFeedBackEmailHTML = (data) => {
    ...
    <body>
        ...
        <div class="content">
            <p>Dear ${fullName},</p>
            <p>Thank you for your feedback. We have received your message and will get back to you as soon as possible.</p>
